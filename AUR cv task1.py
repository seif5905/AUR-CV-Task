...
axes[0, 2].imshow(convolve(img, np.array([[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]])),
cmap='gray')
axes[0, 2].set_title('Horizontal Sobel Filter')
axes[0, 2].axis('off')

axes[1, 0].imshow(convolve(img, np.array([[-1, -2, -1], [0, 0, 0], [1, 2, 1]])),
cmap='gray')
axes[1, 0].set_title('Vertical Sobel Filter')
axes[1, 0].axis('off')

axes[1, 1].imshow(convolve(img, np.array([[0.0751, 0.1238, 0.0751], 
                                          [0.1238, 0.2042, 0.1238], 
                                          [0.0751, 0.1238, 0.0751]])), cmap='gray')
axes[1, 1].set_title("Gaussian Filter")
axes[1, 1].axis("off")

axes[1, 2].imshow(median_filter(img), cmap='gray')
